...
DEFAULT_INVITE_LINK_NAMES = ["profile", "drive2", "vk", "youtube", "partners"]
CHANNEL_DESCRIPTION = (
    "Мировые автоновости на русском: новые модели, цены, электромобили, рынок, законы и автогаджеты. "
    "Коротко, по делу, с фото, характеристиками и ссылками на первоисточники."
)
WELCOME_POST = """🚗 <b>@autonewsrss — мировые автоновости на русском</b>
